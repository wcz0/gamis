 ...
 * 配置 input className
 */
func (a *FileControl) InputClassName(value string) *FileControl {
 ...
 */
func (a *FileControl) AsBase64(value string) *FileControl {
 ...
 * 描述标题
 */
func (a *FileControl) Label(value string) *FileControl {
    a.Set("label", value)
    return a
}
 ...
 * 接口返回的数据中哪个用来作为下载地址。
 */
func (a *FileControl) UrlField(value string) *FileControl {
 ...
 * 静态展示表单项Value类名
 */
func (a *FileControl) StaticInputClassName(value string) *FileControl {
 ...
 * 可以组件级别用来关闭移动端样式
 */
func (a *FileControl) UseMobileUI(value string) *FileControl {
 ...
 * 初始化时是否把其他字段同步到表单内部。
 */
func (a *FileControl) InitAutoFill(value string) *FileControl {
 ...
 * 是否禁用表达式
 */
func (a *FileControl) DisabledOn(value string) *FileControl {
 ...
 * 组件样式
 */
func (a *FileControl) Style(value string) *FileControl {
    a.Set("style", value)
    return a
}
