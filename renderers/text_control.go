 ...
 * 多选模式，值太多时是否避免折行
 */
func (a *TextControl) ValuesNoWrap(value string) *TextControl {
 ...
 * 静态展示空值占位
 */
func (a *TextControl) StaticPlaceholder(value string) *TextControl {
 ...
 * 编辑器配置，运行时可以忽略
 */
func (a *TextControl) EditorSetting(value string) *TextControl {
 ...
 */
func (a *TextControl) Type(value string) *TextControl {
    a.Set("type", value)
    return a
}
 ...
 * 是否显示表达式
 */
func (a *TextControl) VisibleOn(value string) *TextControl {
 ...
 * 描述标题
 */
func (a *TextControl) LabelAlign(value string) *TextControl {
 ...
 */
func (a *TextControl) LabelRemark(value string) *TextControl {
 ...
 * 添加时调用的接口
 */
func (a *TextControl) AddApi(value string) *TextControl {
    a.Set("addApi", value)
    return a
}
 ...
 * 是否只读
 */
func (a *TextControl) ReadOnly(value string) *TextControl {
 ...
 * 是否为多选模式
 */
func (a *TextControl) Multiple(value string) *TextControl {
