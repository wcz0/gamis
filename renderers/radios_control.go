 ...
 * 占位符
 */
func (a *RadiosControl) Placeholder(value string) *RadiosControl {
 ...
 */
func (a *RadiosControl) Mode(value string) *RadiosControl {
    a.Set("mode", value)
    return a
}
 ...
 * 描述内容，支持 Html 片段。
 */
func (a *RadiosControl) Description(value string) *RadiosControl {
 ...
 * 组件样式
 */
func (a *RadiosControl) Style(value string) *RadiosControl {
    a.Set("style", value)
    return a
}
 ...
 * 分割符
 */
func (a *RadiosControl) Delimiter(value string) *RadiosControl {
 ...
 * 是否可以新增
 */
func (a *RadiosControl) Creatable(value string) *RadiosControl {
 ...
 * 选项删除提示文字。
 */
func (a *RadiosControl) DeleteConfirmText(value string) *RadiosControl {
