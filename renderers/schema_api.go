 ...
 */
func (a *SchemaApi) AutoRefresh(value string) *SchemaApi {
 ...
 */
func (a *SchemaApi) TrackExpression(value string) *SchemaApi {
 ...
 */
func (a *SchemaApi) AttachDataToQuery(value string) *SchemaApi {
 ...
 */
func (a *SchemaApi) Cache(value string) *SchemaApi {
    a.Set("cache", value)
    return a
}
