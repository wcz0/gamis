 ...
 * 验证失败的提示信息
 */
func (a *DateControl) ValidationErrors(value string) *DateControl {
 ...
 * 是否静态展示表达式
 */
func (a *DateControl) StaticOn(value string) *DateControl {
 ...
 * 在Table中调整宽度
 */
func (a *DateControl) Width(value string) *DateControl {
    a.Set("width", value)
    return a
}
 ...
 * 可以组件级别用来关闭移动端样式
 */
func (a *DateControl) UseMobileUI(value string) *DateControl {
 ...
 * 静态展示表单项Value类名
 */
func (a *DateControl) StaticInputClassName(value string) *DateControl {
 ...
 * 占位符
 */
func (a *DateControl) Placeholder(value string) *DateControl {
 ...
 * 可选值: full | half | none
 */
func (a *DateControl) BorderMode(value string) *DateControl {
 ...
 * 输入提示，聚焦的时候显示
 */
func (a *DateControl) Hint(value string) *DateControl {
    a.Set("hint", value)
    return a
}
 ...
 * 静态展示表单项Label类名
 */
func (a *DateControl) StaticLabelClassName(value string) *DateControl {
