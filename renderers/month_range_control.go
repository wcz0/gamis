 ...
 * 日期范围快捷键
 */
func (a *MonthRangeControl) Ranges(value string) *MonthRangeControl {
    a.Set("ranges", value)
    return a
}
 ...
 */
func (a *MonthRangeControl) Delimiter(value string) *MonthRangeControl {
 ...
 * 最小跨度，比如 2days
 */
func (a *MonthRangeControl) MinDuration(value string) *MonthRangeControl {
 ...
 */
func (a *MonthRangeControl) Remark(value string) *MonthRangeControl {
    a.Set("remark", value)
    return a
}
 ...
 */
func (a *MonthRangeControl) ExtraName(value string) *MonthRangeControl {
 ...
 * 可以组件级别用来关闭移动端样式
 */
func (a *MonthRangeControl) UseMobileUI(value string) *MonthRangeControl {
 ...
 */
func (a *MonthRangeControl) Size(value string) *MonthRangeControl {
    a.Set("size", value)
    return a
}
...
/**
 */
func (a *MonthRangeControl) Validations(value string) *MonthRangeControl {
 ...
 * 是否显示
 */
func (a *MonthRangeControl) Visible(value string) *MonthRangeControl {
    a.Set("visible", value)
    return a
}
